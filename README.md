...
| ShareGPT                               | 微调Vicuna、SelFee     | 数据关闭开源（[用户提前下载后分享1](https://huggingface.co/datasets/RyokoAI/ShareGPT52K)）（[用户分享下载2](https://huggingface.co/datasets/anon8231489123/ShareGPT_Vicuna_unfiltered)） | 少量中文，个人用户分享和ChatGPT的对话     |
| Alpaca                                 | 微调Alpaca等多模型     | [下载地址](https://github.com/tatsu-lab/stanford_alpaca/blob/main/alpaca_data.json) | 英文，52k self instruct数据                                        |
...
| awesome-open-instruct-data-for-chinese | 中文指令数据集合集 | [下载地址](https://github.com/LianjiaTech/BELLE/blob/main/data/awesome_open_instruct_data_for_chinese.md) | 包含多个中文指令数据集                                       |
| BAAI-OL-CC                             |微调Aquila                       | [下载地址](https://data.baai.ac.cn/details/OL-CC)            | 智源通过众包，人工标注的10k条中文对话数据                            |
...
COIG | 微调Aquila  | [下载地址](https://huggingface.co/datasets/BAAI/COIG)   | 中文，智源开源，中文的OIG
|SelFee 178k | 微调SelFee，使用自反馈 | [下载地址](https://huggingface.co/datasets/kaist-ai/selfee-train) | 纯英文数据，用ChatGPT生成自我反馈和答案，包含数学等其他数据集
|OpenChat ShareGPT4 | 微调OpenChat | [下载地址](https://huggingface.co/datasets/openchat/openchat_sharegpt4_dataset) | 英文，经过清洗的ShareGPT 
